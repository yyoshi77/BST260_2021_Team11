...
shinyApp(ui = fluidPage( 
    ...
    sidebarLayout(
        ...
        sidebarPanel(
            # Explanatory text
            p("This Shiny apps allows you to use a slide bar to see the change of differene in each ranking between 2016 and 2020 Olympics, separately for men and women."),
...
server = function(input, output){
    ...
    output$plot = renderPlot({
        ...
        xlab("rank") +
        ylab("Difference (seconds, Rio minus Tokyo)") +
