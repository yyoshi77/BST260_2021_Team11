...
africa <- tab[[1]] %>% 
  html_table() %>% 
  .[,c(1,3)]
africa <- paste0(africa[,1], africa[,2], "South Sudan")
# Asia
asia <- tab[[2]] %>% 
  html_table() %>% 
  .[,c(1,3)]
...
- `gdp2019`: GDP in 2019 (less missing values)
- `gdp2020`: GDP in 2020 (latest)
