...
##### (Summary) According to the outputs, knn model showed the highest accuracy and the highest AUC (i.e., best discrimination). Then, knn model could be the best model to predict male thletes’ performance in the future Olympic Games during a similar pandemic. However, as the current dataset included very small number of samples, we should ideally repeat similar analyses by using bootstrapping methods or other datasets with larger sample size of athletes and compare the models.
